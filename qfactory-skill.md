...
5. Establish the useful output, real inputs and constraints. If the initial task already contains them, do not ask again. For a general start, help choose a concrete first task.
